...
function addButton(){
    ...
    if ( document.getElementById("entrada").value == "") { 
        ...
        document.getElementById("avisos").innerHTML = "<div class='alert alert-success'>Valor Adicionado a Pilha!</div>";
...
function removeButton(){
    if(pilha.isEmpty() == true){
        document.getElementById("pop").disabled = true;
        document.getElementById("avisos").innerHTML = "<div class='alert alert-warning'>impossivel remover</div>";
