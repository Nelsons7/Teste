...
console.log(vetPar);
document.getElementById("resultado1").innerHTML =  "Par = " + vetPar;
...
document.getElementById("resultado2").innerHTML = "Impar = " + vetImpar;
...
document.getElementById("original").innerHTML = "Todos os meses = " + meses;
...
document.getElementById("resultado1").innerHTML = "Meses menor que 6 = " + mesesMenor;
...
document.getElementById("resultado2").innerHTML = "Meses maior que 6 = " + mesesMaior;
...
document.getElementById("original").innerHTML = "Nomes = " + nomes;
document.getElementById("resultado1").innerHTML = "Sobrenomes = " + sobrenomes;
...
document.getElementById("resultado2").innerHTML = "Nome e Sobrenome = " + nomeSobrenome;
...
console.log(texto);
document.getElementById("original").innerHTML = "Texto = " + texto;
...
var isPresent = function(string, alvo) {
    texto = string.split('');
    document.getElementById("original").innerHTML = "String = " + texto;
    document.getElementById("resultado1").innerHTML = "Alvo = " + alvo;
...
document.getElementById("resultado2").innerHTML = "O alvo contem na String: " + msg;
...
console.log(vet1);
document.getElementById("original").innerHTML = "Vetor 1 = " + vet1;

console.log(vet2);
document.getElementById("resultado1").innerHTML = "Vetor 2 = " + vet2;

vet3 = vet1.filter(value => -1 !== vet2.indexOf(value));
console.log(vet3);
document.getElementById("resultado2").innerHTML = "Vetor 3 = " + vet3;
...
console.log(msg);
document.getElementById("original").innerHTML = "Mensagem = " + msg;
...
document.getElementById("original").innerHTML = mesesColorido;
